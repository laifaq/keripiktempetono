    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="flex items-center gap-3 bg-amber-50 p-4 rounded-2xl border border-amber-100 transition-all hover:shadow-sm">
          ...
          />
          <label htmlFor="popular" className="text-sm font-bold text-amber-900 cursor-pointer select-none">
            ⭐ Badge Populer
          </label>
        </div>

        <div className="flex items-center gap-3 bg-orange-50 p-4 rounded-2xl border border-orange-100 transition-all hover:shadow-sm">
          <input
            type="checkbox"
            id="bestSeller"
            name="bestSeller"
            ...
            onChange={handleChange}
            className="w-5 h-5 text-orange-600 rounded-lg focus:ring-orange-500 border-orange-300"
          />
          <label htmlFor="bestSeller" className="text-sm font-bold text-orange-900 cursor-pointer select-none">
            🔥 Badge Terlaris
          </label>
        </div>
      </div>
