...
export const initialProducts: Product[] = [
  ...
  },
  {
    ...
    description:
      "Keripik tempe with bumbu BBQ smoky yang unik. Aroma panggang yang khas membuat camilan ini cocok dinikmati kapan saja. Rasa western dengan sentuhan lokal.",
    weight: "200g",
